...
console.log(user.sayHello.call(user2, 'Hey')); // output / 
console.log(user.sayHello.apply(user2, ['Hey'])); // output / error
console.log(typeof user.sayHello.bind(user2)); // output / "string"
...
console.log(typeof new MainUser()); // output / undefined
console.log(typeof new MainUser()); // output / undefined
